...
const About = () => {
  return (
    <section
      className="flex flex-col gap-y-12 md:flex-row justify-between items-center scroll-mt-48"
      id="about"
    >
      <img
        src={UMlogo}
        className="lg:w-[400px] lg:h-[450px] md:w-[350px] md:h-[400px] w-[300px] h-[350px] rounded-[50px]"
      />
